<div class="@if(!$edit) hidden @else flex @endif w-screen h-screen top-0 left-0 absolute z-20 items-center justify-center">
    <div class="bg-slate-50 p-6 shadow-xl rounded-lg relative">
        ...
        <form wire:submit="save">
            <div class="grid grid-cols-1 gap-y-2">
                <h3 class="text-lg font-semibold font-sans">Edit Todo</h3>
                    ...
                    <button type="submit" class="p-2 bg-green-600 hover:bg-green-700 font-sans text-white font-semibold w-1/2 rounded-lg justify-self-end">Update</button>
                </div>
            </div>
        </form>
